#!/bin/bash
cd
echo "autoupdate_conf.sh 2.4.6"
echo "© 2020 iDépanne – L'expert informatique"
echo ""
echo ""
echo "*** Mise à jour d'autoupdate.sh ***"
echo ""
echo "wget -O - -t 1 https://raw.githubusercontent.com/idepanne/pi-hole_hosts_project/master/autoupdate.sh > autoupdate_new.sh"
wget -O - -t 1 https://raw.githubusercontent.com/idepanne/pi-hole_hosts_project/master/autoupdate.sh > autoupdate_new.sh
echo ""
